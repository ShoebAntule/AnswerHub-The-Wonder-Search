...
<body>
<script class="search" async src="https://cse.google.com/cse.js?cx=e1a69f4a7dd40448f">
</script>
...
<!-- <nav class="nav">
    ...
    <ul class="nav-list">
        ...
        <li class="nav-item">
            <a href="https://github.com/ShoebAntule" class="nav-link"><i class="fab fa-github"></i></a>
        </li>
        <li class="nav-item">
...
<center class="logo"> <img src="Website logo.jpg" width="30%"></center>
